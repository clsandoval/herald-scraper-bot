...
| signal-mining | mine enriched fields for board signals | standard | chat/feeding/megas/item-shame/ward extremes on the 4.8k corpus yield receipts+filters+sorts with tuned thresholds that eyeball right | VALIDATED (chat is the crown jewel; 327 mega-comebacks; ez-loser x133) | scoring, chat, receipts |
